...
public class AddPasswordGUI extends javax.swing.JFrame {
    ...
    private void generatePswBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generatePswBTNActionPerformed
        ...
        //connect to CryptoUtil 
        String generated = CryptoUtil.generateStrongPassword(16); // Requires CryptoUtils method
    ...
    private void saveBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBTNActionPerformed
        ...
        try {
            //encrypt and save through PasswordsDao (handles salt & iv)
            Connection conn = DatabaseConnection.connect();
            PasswordsDao dao = new PasswordsDao(conn);

            int userId = DBhelper.getUserIdByEmail(userEmail); // link to current user
            if (userId < 0) {
                JOptionPane.showMessageDialog(this, "User not found. Please log in again.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }

            char[] masterPassword = password.toCharArray(); // or use sessionManager.getMasterPassword() if available
